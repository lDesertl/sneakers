                ...
                <div className="cart">
                    ...
                    <div>
                        <div className="cartWrapper d-flex flex-column justify-between align-center text-center">
                                            ...
                                            <div>
                                                {cart ?
                                                    <div className="cartcards d-flex align-center justify-center flex-row">
                                                        ...
                                                        <div className="x d-flex align-center justify-center cu-p" onClick={()=>{
                            ...
                            <Link to={"/order"}>
                                <button className="orderbtn d-flex  align-center justify-center cu-p" onClick={()=>{
                                    {datasneakers.map(({id, cart}) => {
                                        cart && dispatch(stealid("ADD_ORDER", id))
                                        cart && dispatch(stealid("CART", id))
                                ...
                                <Link to={"/"}>
                                    <button className="backbtnb d-flex  align-center justify-center cu-p">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M14.7144 7L1.00007 7" stroke="white" stroke-width="2"
                                                  stroke-linecap="round" stroke-linejoin="round"/>
